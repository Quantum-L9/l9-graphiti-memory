...
#   path: install_generated_data_deployment_wave1.sh
#   layer: repository
...
if [[ -z "$CURSOR_ROOT" ]]; then
  ...
  do
    if [[ -d "$candidate/.git" ]] \
      && [[ -d "$candidate/environment/agents/generated-data" ]]; then
...
required_cursor_files=(
  "$CURSOR_ROOT/environment/agents/generated-data/adapters/graphiti_memory.py"
  "$CURSOR_ROOT/environment/agents/generated-data/retrieval/context_query.py"
  "$CURSOR_ROOT/environment/agents/generated-data/retrieval/reuse_recorder.py"
  "$CURSOR_ROOT/environment/agents/generated-data/invalidation/repository_event_bridge.py"
)
...
L9_SGD_GRAPHITI_INGEST_COMMAND='l9-memory ingest-governed-candidate'
L9_SGD_GRAPHITI_SEARCH_COMMAND='l9-memory search-context'
L9_SGD_GRAPHITI_HYDRATE_COMMAND='l9-memory hydrate-context'
L9_SGD_GRAPHITI_REUSE_COMMAND='l9-memory record-reuse'
L9_SGD_GRAPHITI_INVALIDATE_COMMAND='l9-memory invalidate-source'
