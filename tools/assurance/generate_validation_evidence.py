...
CHECKS: Final[tuple[CheckSpec, ...]] = (
    ...
    CheckSpec(
        ...
        "106 production files pass",
        r"PASS: 106 production Python files",
    ),
    CheckSpec(
        "V-012",
        "security",
    ...
    CheckSpec(
        ...
        "v2.2.0 wheel builds",
        r"Successfully built l9-graphite-memory",
    ),
    CheckSpec(
        "V-017",
        "execution",
        ...
        r"Successfully installed l9-graphite-memory-2.2.0",
    ),
    CheckSpec(
        "V-018",
        "execution",
